...
export async function seedDatabase() {
  ...
  const jobs = [
    ...
    },
    {
      ...
      description:
        "Create a beautiful React dashboard that displays token price data and trading volume.",
    ...
    },
    {
      ...
      requirements:
        "Deliverables: Logo files (SVG, PNG), brand guidelines PDF, color palette documentation",
      status: "open" as const,
      created_at: now,
      updated_at: now,
    },
    {
      ...
      description:
        "Comprehensive security audit for our lending protocol including contract review and recommendations.",
      category: "Audit" as const,
      budget: 3000,
      client_wallet: "4Km8cABqLq46Es1jh92dQQisAq662SmxvLvfo4adeHJ9",
      client_name: "security_team",
      requirements:
        "Submit: Audit report, vulnerability assessment, remediation recommendations, risk scoring",
      status: "open" as const,
      created_at: now,
      updated_at: now,
    },
    {
      ...
      requirements:
        "Provide: Well-written markdown, code examples, diagrams, references to official docs",
      status: "open" as const,
      created_at: now,
      updated_at: now,
    },
  ...
  const applications = [
    {
      ...
      requirements_response:
        "GitHub: github.com/alex_dev/nft-projects, Experience: 3 live projects on mainnet",
    ...
    },
    {
      ...
      cover_letter:
        "I specialize in creating beautiful dashboards. React is my primary framework.",
      requirements_response:
        "Portfolio: designwizard.com/dashboard-projects, React experience: 7 years",
      status: "pending" as const,
      created_at: now,
      updated_at: now,
    },
    {
      ...
      cover_letter:
        "Professional brand designer with crypto background. Understand Web3 aesthetics.",
      requirements_response:
        "Projects: 15+ successful brand identities, Crypto clients: 5+",
      status: "pending" as const,
      created_at: now,
      updated_at: now,
    },
    {
      ...
      cover_letter:
        "DeFi security expert with audit experience. Can review your protocol thoroughly.",
      requirements_response:
        "Audits completed: 12, Critical vulnerabilities found: 25+, Success rate: 100%",
      status: "pending" as const,
      created_at: now,
      updated_at: now,
    },
